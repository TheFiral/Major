def groupOne():
    ...
    str = input()
    if "да" == str:
        print("Идентификация, проверка подлинности и контроль доступа субъектов: в систему\n" +
...
def groupTwoDetail():
    ...
    str = input()
    if "да" == str:
        print("Идентификация, проверка подлинности и контроль доступа\n" +
            "субъектов:\n" +
            "· в систему\n" +
...
def groupThree():
    ...
    str = input()
    if "да" == str:
        print("Идентификация, проверка подлинности и контроль\n" +
            "доступа субъектов:\n" +
            "· в систему\n" +
            "· к терминалам, ЭВМ, узлам сети ЭВМ, каналам связи, внешним устройствам ЭВМ\n" +
            "· к программам\n" +
